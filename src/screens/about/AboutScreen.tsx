...
const makeStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  heroLogo: { fontFamily: FontFamily.logo, fontSize: 28, color: 'rgba(255,255,255,0.8)', letterSpacing: -0.5 },
  heroLogoWhite: { color: C.white },
  heroTagline: { fontFamily: FontFamily.body, fontSize: FontSize.sm, color: 'rgba(255,255,255,0.8)', textAlign: 'center', lineHeight: 20 },
  heroBadge: { backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: Radius.full, paddingHorizontal: Spacing['3'], paddingVertical: 4, marginTop: Spacing['1'] },
  heroBadgeText: { fontFamily: FontFamily.body, fontSize: FontSize.xs, color: C.white },
  section: { paddingHorizontal: Spacing['4'], paddingTop: Spacing['5'], paddingBottom: Spacing['2'] },
  sectionTitle: { fontFamily: FontFamily.headingBold, fontSize: FontSize.base, color: C.textPrimary, marginBottom: Spacing['3'] },
  body: { fontFamily: FontFamily.body, fontSize: FontSize.base, color: C.textSecondary, lineHeight: 24 },
  statsRow: {
    flexDirection: 'row',
  ...
  statItem: { flex: 1, alignItems: 'center', paddingVertical: Spacing['4'], borderRightWidth: 1, borderRightColor: C.borderLight, gap: 4 },
  statValue: { fontFamily: FontFamily.headingBold, fontSize: FontSize['2xl'], color: C.primary },
  statLabel: { fontFamily: FontFamily.body, fontSize: FontSize.xs, color: C.textMuted, textAlign: 'center' },
  teamRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing['3'], paddingVertical: Spacing['2'] },
  teamIconWrap: { width: 36, height: 36, borderRadius: Radius.sm, backgroundColor: C.background, alignItems: 'center', justifyContent: 'center' },
  teamName: { fontFamily: FontFamily.bodySemiBold, fontSize: FontSize.base, color: C.textPrimary },
  teamRole: { fontFamily: FontFamily.body, fontSize: FontSize.sm, color: C.textMuted },
  socialsRow: { flexDirection: 'row', gap: Spacing['3'], flexWrap: 'wrap' },
  socialBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: Spacing['2'],
  ...
  socialLabel: { fontFamily: FontFamily.body, fontSize: FontSize.sm, color: C.textSecondary },
  contactBlock: { paddingHorizontal: Spacing['4'], paddingTop: Spacing['5'], gap: Spacing['2'] },
  contactRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing['2'] },
  contactLink: { fontFamily: FontFamily.body, fontSize: FontSize.base, color: C.primary },
  contactHours: { fontFamily: FontFamily.body, fontSize: FontSize.sm, color: C.textMuted },
  legalBlock: {
    marginHorizontal: Spacing['4'],
    marginTop: Spacing['5'],
    backgroundColor: C.backgroundCard,
  ...
  legalLabel: { flex: 1, fontFamily: FontFamily.body, fontSize: FontSize.base, color: C.textSecondary },
  footer: { alignItems: 'center', paddingTop: Spacing['6'], paddingBottom: Spacing['4'], gap: 4 },
  footerText: { fontFamily: FontFamily.body, fontSize: FontSize.sm, color: C.textMuted },
  footerSub: { fontFamily: FontFamily.body, fontSize: FontSize.xs, color: C.textDisabled },
});
